...
const InsuranceLearningPage: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    return (
             ...
             <header className="flex items-center mb-6 flex-shrink-0">
                ...
                <div className="text-center flex-1">
                    <div className="flex items-center justify-center space-x-2">
                        <BookOpenIcon />
                        <h1 className="text-2xl font-bold text-gray-200">Insurance Learning Hub</h1>
                    </div>
                     <p className="text-sm text-gray-400">Knowledge is your best policy.</p>
                </div>
...
export default InsuranceLearningPage;
