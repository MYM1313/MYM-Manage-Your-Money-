...
const HeroSection: FC = () => {
    ...
    const insights = useMemo(() => {
        ...
        lines.push({ text: "Your future self is already proud of you. Stay consistent.", icon: <SparklesIconHero className="text-sky-300" />, glowClass: 'animate-pulse-glow-blue' });
